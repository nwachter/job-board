  ...
  return (
    <div className="h-full w-full">
      {/* <Form
        ...
        description={
          "Remplissez les champs suivants pour créer une offre d'emploi"
        }
        fields={[
          {
            name: "title",
          ...
          },
          {
            ...
            icon: <FileText />,
            value: String(inputs.description),
          },
          {
            name: "company_name",
            type: "text",
            ...
            value: String(inputs.company_name),
          },
          {
            name: "city",
            type: "text",
          ...
          },
          {
            ...
            value: String(inputs.contract_type),
          },
        ]}
