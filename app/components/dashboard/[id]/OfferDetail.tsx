...
import OfferSkillsDisplay from "../../general/OfferSkillsDisplay";
...
//Composant du détail (contenu dans OfferDetailPage.tsx)
const OfferDetail: React.FC<OfferDetailProps> = ({ offer, onDelete, userInfo }) => {
    ...
    <div className="h-full w-full px-6">
      <div className="flex h-full w-full flex-col items-center justify-center text-white">
        ...
        >
              ...
              {userInfo.role === Role.ADMIN ||
                (userInfo.role === Role.RECRUITER && (
                  <button
                    ...
                    className="flex w-full  items-center justify-center  transition-all px-2 py-2 text-left text-red-600 hover:bg-slate-100 rounded-full"
                  >
                  ...
                  {isShareMenuOpen && (
                    ...
                    >
                      <button
                        ...
                        className="flex w-full items-center px-4 py-2 text-left hover:bg-slate-100 transition-all "
                      >
                        <svg className="mr-3 h-5 w-5 text-[#0077B5]" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      >
                        <svg className="mr-3 h-5 w-5 text-[#1DA1F2]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <OfferSkillsDisplay skills={offer.skills ?? []} />
