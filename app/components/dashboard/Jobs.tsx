        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white/70 rounded-[30px] p-6 mb-8 shadow-md">
            <form onSubmit={handleSubmit} className="flex gap-4">
              ...
              <button type="submit" className="bg-purple-600 text-white px-6 relative py-2 flex items-center gap-1.5  rounded-full active:bg-purple-700 transition-all hover:bg-purple-500"><Search className="rotate-90 text-purple-200" size={25} />
              </button>
            </form>
          </div>
