  ...
  if (isLoading)
    return (
      <div className="flex h-full items-center justify-center">
        ...
        <span className="ml-3 font-medium text-white">Chargement des candidatures...</span>
      </div>
    );
    ...
    <div className="flex h-full w-full">
      <main className="ml-20 flex-1 p-8">
        <div className="mx-auto max-w-7xl">
          ...
          >
            <h1 className="font-merriweather-sans text-4xl font-bold text-white">Candidatures</h1>
          ...
          {filteredApplications && filteredApplications.length > 0 ? (
            ...
            >
              ...
              <h3 className="mb-2 text-xl font-medium text-gray-800">Aucune candidature trouvée</h3>
