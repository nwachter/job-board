...
const UserDashboard: React.FC<UserDashboardProps> = ({ offers, contractTypes, locations, isLoading, isError, error }) => {
  ...
  if (isError ) return <div className="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 transition-all">{error ? error.message : "Erreur lors de la recherche des localisations"}</div>;
  if (isLoading) return (
