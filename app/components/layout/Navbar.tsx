...
export const NavItem: React.FC<NavItemProps> = ({ icon, title, isExpanded, isActive, onClick }) => (
    <div
        onClick={onClick}
        className={`
...
export const Navbar = () => {
    ...
    return (
        ...
        >
            <div className="p-4">
                <h1 className={`font-bold  font-merriweather-sans text-xl ${!isNavExpanded && 'hidden'}`}>
                    JobBoard
                </h1>
                <span className={`text-xl font-bold ${isNavExpanded && 'hidden'}`}>JB</span>
            </div>
